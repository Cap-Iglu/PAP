...
public class Vianadocastelomenuact extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.vianadocastelo_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Vianadocastelomenuact.this, contentmain.class);
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Vianadocastelomenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
