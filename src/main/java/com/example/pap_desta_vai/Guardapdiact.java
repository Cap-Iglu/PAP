...
public class Guardapdiact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pdiguarda);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Guardapdiact.this, Guardamenuact.class);
        ...
        jdpbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Guardapdiact.this, Castelobrancojdpact.class);
                startActivity(intent);
            }
        });
