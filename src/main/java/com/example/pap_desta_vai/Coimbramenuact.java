...
public class Coimbramenuact extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coimbra_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Coimbramenuact.this, contentmain.class);
        ...
        infbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coimbramenuact.this, Coimbrainfact.class);
                startActivity(intent);
            }
        });
        ...
        pdibtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coimbramenuact.this, Coimbrapdiact.class);
                startActivity(intent);
            }
        });
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coimbramenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
