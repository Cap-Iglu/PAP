...
public class Lisboamenuact extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lisboa_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Lisboamenuact.this, contentmain.class);
        ...
        infbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Lisboamenuact.this, Lisboainfact.class);
                startActivity(intent);
            }
        });
        ...
        pdibtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Lisboamenuact.this, Lisboapdiact.class);
                startActivity(intent);
            }
        });
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Lisboamenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
