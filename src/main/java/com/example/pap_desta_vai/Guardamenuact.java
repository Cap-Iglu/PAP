...
public class Guardamenuact extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.guarda_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Guardamenuact.this, contentmain.class);
        ...
        infbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Guardamenuact.this, Guardainfact.class);
                startActivity(intent);
            }
        });
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Guardamenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
