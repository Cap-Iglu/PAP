...
public class Madeiramenuact extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.madeira_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Madeiramenuact.this, contentmain.class);
        ...
        infbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Madeiramenuact.this, Madeirainfact.class);
                startActivity(intent);
            }
        });
        ...
        pdibtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Madeiramenuact.this, Madeirapdiact.class);
                startActivity(intent);
            }
        });
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Madeiramenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
