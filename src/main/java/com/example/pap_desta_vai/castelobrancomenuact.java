...
public class castelobrancomenuact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.castelobranco_menu);
        ...
        voltarbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(castelobrancomenuact.this, contentmain.class);
        ...
        pdibtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(castelobrancomenuact.this, AcoresPdiact.class);
                startActivity(intent);
            }
        });
        ...
        gastrobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(castelobrancomenuact.this, Gastronomiaact.class);
                startActivity(intent);
            }
        });
